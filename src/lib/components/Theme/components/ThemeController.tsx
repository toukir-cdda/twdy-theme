...
const ThemeController = ({
  ...
  return withActionButton ? (
    ...
    <div
      className={`flex justify-center items-center flex-col gap-2  ${className && className}`}
    >
      {/* color palette */}
...
const WithAction = ({ handleChangePrimary, handleChangeSecondary }: any) => {
  const { theme, themeList, toggleTheme, removeTheme, toggleDarkMode } =
    useTheme();
  return (
    <Popover>
